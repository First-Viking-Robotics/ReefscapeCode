...
class TunerConstants:
    ...
    _front_left_encoder_offset: units.rotation = 0.156982421875
    _front_left_steer_motor_inverted = True
    _front_left_encoder_inverted = False

    _front_left_x_pos: units.meter = inchesToMeters(12.5)
    _front_left_y_pos: units.meter = inchesToMeters(12.5)

    # Front Right
    _front_right_drive_motor_id = 14
    _front_right_steer_motor_id = 15
    _front_right_encoder_id = 16
    _front_right_encoder_offset: units.rotation = 0.35107421875
    _front_right_steer_motor_inverted = True
    _front_right_encoder_inverted = False

    _front_right_x_pos: units.meter = inchesToMeters(12.5)
    _front_right_y_pos: units.meter = inchesToMeters(-12.5)

    # Back Left
    _back_left_drive_motor_id = 18
    _back_left_steer_motor_id = 19
    _back_left_encoder_id = 20
    _back_left_encoder_offset: units.rotation = 0.43701171875
    _back_left_steer_motor_inverted = True
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-12.5)
    _back_left_y_pos: units.meter = inchesToMeters(12.5)

    # Back Right
    _back_right_drive_motor_id = 22
    _back_right_steer_motor_id = 23
    _back_right_encoder_id = 24
    _back_right_encoder_offset: units.rotation = -0.098876953125
    _back_right_steer_motor_inverted = True
    _back_right_encoder_inverted = False

    _back_right_x_pos: units.meter = inchesToMeters(-12.5)
    _back_right_y_pos: units.meter = inchesToMeters(-12.5)
