...
class PhysicsEngine:
    def __init__(self, physics_controller: PhysicsInterface, robot: "MyRobot"):
        ...
        # # Motors
        # self.lf_motor = phoenix6.hardware.TalonFX(0)
        # self.lr_motor = phoenix6.hardware.TalonFX(1)
        # self.rf_motor = phoenix6.hardware.TalonFX(2)
        # self.rr_motor = phoenix6.hardware.TalonFX(3)
